...
export async function writeJSON(obj, path) {
...
export function buildIndex(list) {
  ...
  fs.writeFile("out/fuse-index.json", JSON.stringify(index.toJSON()));
  fs.writeFile("out/papers-meta.json", JSON.stringify(list));
}
